...
./chainConfigurator.py -W 60 -H 60 -C 0.25 -I 0.0 -n 100 ./ChainFiles/LongTerm_1_Fast.chains
#osascript -e 'tell app "Terminal"
#do script "~/academia/github_Repositories/active-microemulsion/active-microemulsion --threads 1 -W 60 -H 60 -w 0.5 -s 3000 --kRnaPlus 1e-1 --kRnaMinusRbp 8.3333e-4 --kChromPlus 1.5e-2 --kChromMinus 1.6666e-3 --kOn 1e-2 --kOff 0 --kRnaTransfer 3.3e-3 -t 30 --additional-snapshots --flavopiridol 0 -E 18000 -T 18000 -P ~/academia/github_Repositories/active-microemulsion/utils/ChainFiles/LongTerm_1_Fast.chains -o ~/academia/github_Repositories/active-microemulsion/utils/LongTermOut/Inactive_Fast"
#end tell'

# With transcription, fast
#./chainConfigurator.py -W 60 -H 60 -C 0.25 -I 0.0 -n 100 ./ChainFiles/LongTerm_2_Fast.chains
#osascript -e 'tell app "Terminal"
...
./chainConfigurator.py -W 60 -H 60 -C 0.25 -I 0.0 -n 100 ./ChainFiles/LongTerm_3_Fast.chains
osascript -e 'tell app "Terminal"
do script "~/academia/github_Repositories/active-microemulsion/active-microemulsion --threads 1 -W 60 -H 60 -w 0.5 -s 3000 --kRnaPlus 1e+1 --kRnaMinusRbp 0 --kChromPlus 5e-3 --kChromMinus 1.6666e-2 --kOn 2.500e-4 --kOff 3.3333e-3 --kRnaTransfer 3.3e-3 -t 30 --additional-snapshots --flavopiridol 0 --activate 60 --flavopiridol 1000 -E 100000 -T 100000 -P ~/academia/github_Repositories/active-microemulsion/utils/ChainFiles/LongTerm_3_Fast.chains -o ~/academia/github_Repositories/active-microemulsion/utils/LongTermOut/Inhibited_Fast"
end tell'
